...
params:
  ...
  n_data_perturbations:
    ...
    # increase for better measure of stability, but at the cost of higher computational load
    value: 2  
    input: numeric
  seed:
    label: "Random Seed"
...
# set up knitr options for vdoc template
vdoc_knitr_setup()
...
<span style="color:red">TODO: Add drag and drop feature in shiny version for other images</span
...
for (dtype in names(tab_ls)) {  # grouped by data type
  subchunkify(tab_ls[[dtype]], i = .chunk_globalenv$chunk_idx, 
