...
TODO: Tiffany - Provide some code to automate parts of this.
...
TODO: Ana - Provide some example code here (for both fitting and visualizing results) so that the practitioner can easily input their data and models.
Add something like James' slide. A few pictures with possible data perturbation schemes (separate from parameter tuning). Data splitting vs sampling of observations. Cross-validation-ish scheme and fixed training/validation setup (bootstrapping, sub-sampling, stratified-sampling).
Add parameter to include/exclude certain code chunks.
